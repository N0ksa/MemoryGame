...
import com.example.memorygame.memory_feature.presentation.memory_screen.components.BuildButtons
import com.example.memorygame.memory_feature.presentation.memory_screen.components.IconButton
import com.example.memorygame.memory_feature.presentation.memory_screen.components.MemoryGameCard
import com.example.memorygame.memory_feature.presentation.util.calculateRowRanges
...
fun MemoryScreen(
    ...
    Box (
        ...
        Row(
            ...
            val rowRanges = calculateRowRanges(state.pairCount, isPortrait)
